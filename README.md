...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9ymux5c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9ymux5c.containers.anotherwebservice.com/
...
```
git clone git@github.com:rufailimantawa/container-9ymux5c.git
cd container-9ymux5c
```
...
```
docker attach container-9ymux5c
```
